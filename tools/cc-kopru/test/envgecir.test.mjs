...
test("video: altIzin'de whisper yok, envGecir jev ile ayni", () => {
  assert.deepEqual(AYAR.izinli.video.altIzin, ["ozet", "suz", "sor", "kare", "temizle", "oku", "adlar", "rapor-denetle", "izle", "paket", "durum", "bilgi", "brief"]);  // 12b: kayit/toplu yalniz CC; 12c: izle, paket; 15: durum, bilgi; 17: brief
