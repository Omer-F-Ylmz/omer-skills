...
6. **Erişilebilirlik (axe)** — frontend-craft audit.mjs; bulgu varsa `fixing-accessibility`, teslim öncesi `accessibility-review`. Kontrast, klavye, odak, alt metin 0 hata.
...
10. **Kapanış** — `design-critique`, tur raporu (frontend-craft ÇEKİRDEK formatı), omer-kurallar:15 altı madde (fonksiyon · güvenlik · bağımlılık · ZAP · KVKK · SEO/A11y; SEO için `fixing-metadata`).
